...
{
    public class MoneyLoverSeedData
    {
        public MoneyLoverSeedData()
        {
            Thread seed = new Thread(Seed);
            seed.Start();
        }
        public void Seed()
        {
            ...
            {
                db.Users.Add(new User { Email = "user1@moneylover.com", Password = "moneylover" });
                db.Users.Add(new User { Email = "user2@moneylover.com", Password = "moneylover" });
                db.Users.Add(new User { Email = "user3@moneylover.com", Password = "moneylover" });
                db.Users.Add(new User { Email = "user4@moneylover.com", Password = "moneylover" });
                db.Users.Add(new User { Email = "user5@moneylover.com", Password = "moneylover" });
                db.Users.Add(new User { Email = "user6@moneylover.com", Password = "moneylover" });
                db.Users.Add(new User { Email = "user7@moneylover.com", Password = "moneylover" });
                db.Users.Add(new User { Email = "user8@moneylover.com", Password = "moneylover" });
                db.Users.Add(new User { Email = "user9@moneylover.com", Password = "moneylover" });
                db.Users.Add(new User { Email = "user10@moneylover.com", Password = "moneylover" });
